...
class MainPage(WebPage):
   ...
   # футер
    ...
    # brands= WebElement(xpath='(//*[@target="_self"])[27]//i')
    brands= WebElement(xpath='//a[contains(@href, "brands")][@class="module_link__wJY1i"]')

    brands_link=ManyWebElements(xpath='//a[@class="brands_brand_card__pOg7K"]')
    katalog_prodycty=WebElement(xpath='(//*[@role="menu"]/*[1])')
    made_in_belarus_toogle=WebElement(xpath='(//div[@class="toggle_toggle__WFDLb"])[1]')
    toggle_checkbox=WebElement(xpath='(//input[@class="toggle_checkbox__jAMIn"])[1]')
    # made_in_belarus_toogle=WebElement(xpath='//div[@class="toggle_toggle__WFDLb toggle_toggle_checked__EQf7Q"]')
    # made_in_belarus_lables=ManyWebElements(xpath='//span[contains(text(), "Беларусь")]')
    made_in_belarus_product=WebElement(xpath='(//div[@class="card-image_container__ag0cA"])[1]')
    strana_product=WebElement(xpath='//span[@class="preview_full__value__XTBh6"]')
    first_slide=WebElement(xpath='(//div[@data-swiper-slide-index="0"])[1]')
